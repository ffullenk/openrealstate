...
class CustomGMap {
	public static function creatMap(){
		...
		$gMap->setWidth('100%');
		$gMap->setHeight(550);
		$gMap->zoom = param('module_apartments_gmapsZoomCity', 11);
		...
		$centerX    =	param('module_apartments_gmapsCenterX', 37.620717508911184);
		$centerY    =	param('module_apartments_gmapsCenterY', 55.75411314653655);
		if ($centerX && $centerY){
		...
		//$gMap->zoom = param('module_apartments_gmapsZoomApartment', 16);

...
class CustomYMap {
	...
	public function createMap(){
		...
		Yii::app()->clientScript->registerScriptFile(Yii::app()->request->baseUrl.'/js/yandexmap.clusterer.min.js', CClientScript::POS_END);
	...
	public function setClusterer() {
		$this->scripts[] = '
			...
			clusterer.setMarkers(markers); /* add markers in clusterer */
            clusterer.repaint(); /* refresh clusterer in map */
		';
	}

...
<head>
    ...
    <style>
        ...
        h1 {color: black; font-size: 1.6em; font-weight: bold; margin: 0.5em 0pt; }
        h2 { color: black; font-size: 1.25em; font-weight: bold;  margin: 0.3em 0pt; }
        h3 {color: black; font-size: 1.1em; font-weight: bold; margin: 0.2em 0pt; }
	...
	<div id="container">
		<div class="logo">
			<a title="<?php echo tFile::getT('module_install', 'Go to main page'); ?>" href="<?php echo Yii::app()->request->baseUrl; ?>/">
				<img width="302" height="62" alt="<?php echo tFile::getT('module_install', 'Open Real Estate'); ?>" src="<?php echo Yii::app()->request->baseUrl; ?>/images/pages/logo-open-re.png" id="logo" />
			</a>
		</div>
		<div class="content">
			<?php echo $content; ?>
